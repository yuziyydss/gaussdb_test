-- generated_from: manifest_m_drop_index_online_single
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_drop_index_online_single_f527f504ef48
-- expected: error
-- expected_error_category: online_single
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"dependency": "m_drop_index_dependency_restrict", "form": "m_drop_index_form_ordinary", "if_exists": "m_drop_index_if_exists_none", "online": "m_drop_index_online_on", "tail": "m_drop_index_tail_none", "targets": "m_drop_index_targets_two"}
...
-- test_sql:
DROP INDEX CONCURRENTLY m_b03_existing_index, m_b03_existing_index_two RESTRICT;
-- fixture_teardown:
