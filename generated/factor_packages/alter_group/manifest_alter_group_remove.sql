-- generated_from: manifest_alter_group_remove
-- static_only: true
-- case_count: 2

-- case_id: manifest_alter_group_remove_9b40b80b0618
-- expected: success
...
-- params: {"form": "alter_group_form_remove", "members": "alter_group_members_one"}
...
GRANT b9_role_a TO b9_role_b, b9_role_c;
-- test_sql:
ALTER GROUP b9_role_a DROP USER b9_role_b;
-- fixture_teardown:
...
-- case_id: manifest_alter_group_remove_fb6a6113c73b
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"form": "alter_group_form_remove", "members": "alter_group_members_two"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["create_role::create_role_fact_privilege"], "key": "dedicated_role_admin"}, {"allowed_values": ["true"], "fact_refs": ["create_role::create_role_fact_disable_admin"], "key": "password_disable_admin"}]
-- fixture_setup:
CREATE ROLE b9_role_a NOLOGIN PASSWORD DISABLE;
CREATE ROLE b9_role_b NOLOGIN PASSWORD DISABLE;
...
GRANT b9_role_a TO b9_role_b, b9_role_c;
-- test_sql:
ALTER GROUP b9_role_a DROP USER b9_role_b, b9_role_c;
-- fixture_teardown:
REVOKE b9_role_a FROM b9_role_b, b9_role_c;
DROP ROLE IF EXISTS b9_role_c;
DROP ROLE IF EXISTS b9_role_b;
