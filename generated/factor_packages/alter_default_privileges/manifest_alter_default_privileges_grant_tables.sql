-- generated_from: manifest_alter_default_privileges_grant_tables
-- static_only: true
-- case_count: 5

-- case_id: manifest_alter_default_privileges_grant_tables_39553d379b22
-- expected: success
...
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT SELECT ON TABLES TO b9_role_b;
-- fixture_teardown:
...
-- case_id: manifest_alter_default_privileges_grant_tables_627eedb993b0
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT SELECT, INSERT ON TABLES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_grant_tables_5576704ba1eb
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT SELECT ON TABLES TO b9_role_b WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_grant_tables_e79612a88710
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT SELECT ON TABLES TO b9_role_b, b9_role_c;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_grant_tables_9e9845bd458e
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT SELECT, INSERT ON TABLES TO b9_role_b;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
