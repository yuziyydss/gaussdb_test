-- generated_from: manifest_alter_default_privileges_grant_types
-- static_only: true
-- case_count: 4

-- case_id: manifest_alter_default_privileges_grant_types_34343ab037cd
-- expected: success
...
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT USAGE ON TYPES TO b9_role_b;
-- fixture_teardown:
...
-- case_id: manifest_alter_default_privileges_grant_types_e86b4600ff56
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT USAGE ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_grant_types_2eeba0fd14c4
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT USAGE ON TYPES TO b9_role_b WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_grant_types_e54ef77ec7f0
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA fp_cs_one TO b9_role_b, b9_role_c;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT USAGE ON TYPES TO b9_role_b, b9_role_c;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
