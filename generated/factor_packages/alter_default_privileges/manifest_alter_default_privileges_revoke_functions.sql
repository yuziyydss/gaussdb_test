-- generated_from: manifest_alter_default_privileges_revoke_functions
-- static_only: true
-- case_count: 8

-- case_id: manifest_alter_default_privileges_revoke_functions_b653ae967fa7
-- expected: success
...
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE EXECUTE ON FUNCTIONS FROM b9_role_b;
-- fixture_teardown:
...
-- case_id: manifest_alter_default_privileges_revoke_functions_0f5b27a31415
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE GRANT OPTION FOR EXECUTE ON FUNCTIONS FROM b9_role_b, b9_role_c RESTRICT;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_6126278c6ef1
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE GRANT OPTION FOR EXECUTE ON FUNCTIONS FROM b9_role_b CASCADE;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_ac056c8393c9
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE EXECUTE ON FUNCTIONS FROM b9_role_b, b9_role_c CASCADE CONSTRAINTS;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_4f579988c910
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE EXECUTE ON FUNCTIONS FROM b9_role_b RESTRICT;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_f9a096f44f4b
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE GRANT OPTION FOR EXECUTE ON FUNCTIONS FROM b9_role_b CASCADE CONSTRAINTS;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_661c00ba7335
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE EXECUTE ON FUNCTIONS FROM b9_role_b, b9_role_c CASCADE;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
...
-- case_id: manifest_alter_default_privileges_revoke_functions_81e577ed934d
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one GRANT ALL PRIVILEGES ON TYPES TO b9_role_b, b9_role_c WITH GRANT OPTION;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE GRANT OPTION FOR EXECUTE ON FUNCTIONS FROM b9_role_b, b9_role_c;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON TABLES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON SEQUENCES FROM b9_role_b, b9_role_c;
ALTER DEFAULT PRIVILEGES IN SCHEMA fp_cs_one REVOKE ALL PRIVILEGES ON FUNCTIONS FROM b9_role_b, b9_role_c;
