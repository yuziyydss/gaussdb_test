-- generated_from: manifest_alter_masking_policy_comment
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_masking_policy_comment_a6988c0f0cf2
-- expected: success
...
-- params: {"operation": "alter_masking_policy_operation_comment"}
...
-- test_sql:
ALTER MASKING POLICY b10_mask_existing COMMENTS 'b10 masking policy';
-- fixture_teardown:
