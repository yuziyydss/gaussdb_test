-- generated_from: manifest_alter_masking_policy_disable
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_masking_policy_disable_9f8a29b20597
-- expected: success
...
-- params: {"operation": "alter_masking_policy_operation_disable"}
...
-- test_sql:
ALTER MASKING POLICY b10_mask_existing DISABLE;
-- fixture_teardown:
