-- generated_from: manifest_alter_masking_policy_modify
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_masking_policy_modify_30bb0a5e99df
-- expected: success
...
-- params: {"operation": "alter_masking_policy_operation_modify"}
...
-- test_sql:
ALTER MASKING POLICY b10_mask_existing MODIFY randommasking ON LABEL(b10_mask_a);
-- fixture_teardown:
