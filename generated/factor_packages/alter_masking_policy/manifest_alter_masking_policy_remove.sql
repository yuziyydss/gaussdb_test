-- generated_from: manifest_alter_masking_policy_remove
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_masking_policy_remove_957c00ac67ed
-- expected: success
...
-- params: {"operation": "alter_masking_policy_operation_remove"}
...
-- test_sql:
ALTER MASKING POLICY b10_mask_existing REMOVE randommasking ON LABEL(b10_mask_b);
-- fixture_teardown:
