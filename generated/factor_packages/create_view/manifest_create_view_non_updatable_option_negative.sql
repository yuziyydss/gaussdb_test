...
-- case_id: manifest_create_view_non_updatable_option_negative_f8e9a8612ae8
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_unpivot_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_cascaded"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_f8e9a861 WITH (check_option = CASCADED) AS SELECT metric_name, metric_value FROM t_view_source UNPIVOT (metric_value FOR metric_name IN (col_1 AS 'COL_1', col_2 AS 'COL_2'));
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_option_negative_18fe724fb5ba
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_start_with_connect_by_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_cascaded"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_18fe724f WITH (check_option = CASCADED) AS SELECT col_1, col_2 FROM t_view_source START WITH col_1 = 1 CONNECT BY PRIOR col_1 = col_2;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_option_negative_22bc38d0cac6
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_flashback_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_cascaded"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_22bc38d0 WITH (check_option = CASCADED) AS SELECT col_1, col_2 FROM t_cv_flashback_source TIMECAPSULE TIMESTAMP (CURRENT_TIMESTAMP - INTERVAL '1 minute');
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;
...
-- case_id: manifest_create_view_non_updatable_option_negative_3bbfd053918c
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_unpivot_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_local"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_3bbfd053 (c1, c2) WITH (check_option = LOCAL) AS SELECT metric_name, metric_value FROM t_view_source UNPIVOT (metric_value FOR metric_name IN (col_1 AS 'COL_1', col_2 AS 'COL_2'));
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_option_negative_45a70a273fd7
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_start_with_connect_by_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_local"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_45a70a27 (c1, c2) WITH (check_option = LOCAL) AS SELECT col_1, col_2 FROM t_view_source START WITH col_1 = 1 CONNECT BY PRIOR col_1 = col_2;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_option_negative_9b561bcf2d64
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "post_query_none", "query_profile": "query_flashback_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_option_check_local"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_option_check_9b561bcf (c1, c2) WITH (check_option = LOCAL) AS SELECT col_1, col_2 FROM t_cv_flashback_source TIMECAPSULE TIMESTAMP (CURRENT_TIMESTAMP - INTERVAL '1 minute');
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;
