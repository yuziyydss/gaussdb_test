...
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
...
-- case_id: manifest_create_view_non_updatable_trailing_negative_c08967abe5f7
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_default", "query_profile": "query_unpivot_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_c08967ab AS SELECT metric_name, metric_value FROM t_view_source UNPIVOT (metric_value FOR metric_name IN (col_1 AS 'COL_1', col_2 AS 'COL_2')) WITH CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_dda1074059f0
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_default", "query_profile": "query_start_with_connect_by_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_dda10740 AS SELECT col_1, col_2 FROM t_view_source START WITH col_1 = 1 CONNECT BY PRIOR col_1 = col_2 WITH CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_a38c7c2f53d3
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_default", "query_profile": "query_flashback_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_a38c7c2f AS SELECT col_1, col_2 FROM t_cv_flashback_source TIMECAPSULE TIMESTAMP (CURRENT_TIMESTAMP - INTERVAL '1 minute') WITH CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;
...
-- case_id: manifest_create_view_non_updatable_trailing_negative_177995da0ca9
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_cascaded", "query_profile": "query_unpivot_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_177995da (c1, c2) AS SELECT metric_name, metric_value FROM t_view_source UNPIVOT (metric_value FOR metric_name IN (col_1 AS 'COL_1', col_2 AS 'COL_2')) WITH CASCADED CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_35aed4f7421d
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_cascaded", "query_profile": "query_start_with_connect_by_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_35aed4f7 (c1, c2) AS SELECT col_1, col_2 FROM t_view_source START WITH col_1 = 1 CONNECT BY PRIOR col_1 = col_2 WITH CASCADED CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_e09f257238fe
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_two_aliases", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_cascaded", "query_profile": "query_flashback_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_e09f2572 (c1, c2) AS SELECT col_1, col_2 FROM t_cv_flashback_source TIMECAPSULE TIMESTAMP (CURRENT_TIMESTAMP - INTERVAL '1 minute') WITH CASCADED CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;
...
-- case_id: manifest_create_view_non_updatable_trailing_negative_c616416d6856
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_local", "query_profile": "query_unpivot_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_c616416d AS SELECT metric_name, metric_value FROM t_view_source UNPIVOT (metric_value FOR metric_name IN (col_1 AS 'COL_1', col_2 AS 'COL_2')) WITH LOCAL CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_8de924664570
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_local", "query_profile": "query_start_with_connect_by_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_8de92466 AS SELECT col_1, col_2 FROM t_view_source START WITH col_1 = 1 CONNECT BY PRIOR col_1 = col_2 WITH LOCAL CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;

-- case_id: manifest_create_view_non_updatable_trailing_negative_94908c50bc99
-- expected: error
-- expected_error_category: check_option_requires_updatable_view
-- expected_sqlstates: -
-- expected_error_regex: (?i)(check[ _]?option|updatable|view)
-- params: {"column_list": "column_list_inherited", "force_modifier": "force_absent", "or_replace": "or_replace_absent", "post_query_option": "check_local", "query_profile": "query_flashback_two_columns", "temp_modifier": "temp_absent", "view_options_profile": "view_options_none"}
-- fixture_setup:
DROP TABLE IF EXISTS t_view_source CASCADE;
CREATE TABLE t_view_source (col_1 INTEGER, col_2 INTEGER);
INSERT INTO t_view_source (col_1, col_2) VALUES (1, 2), (3, 4);
...
INSERT INTO t_cv_flashback_source (col_1, col_2) VALUES (1, 2), (3, 4);
-- test_sql:
CREATE VIEW v_cv_bad_tail_check_94908c50 AS SELECT col_1, col_2 FROM t_cv_flashback_source TIMECAPSULE TIMESTAMP (CURRENT_TIMESTAMP - INTERVAL '1 minute') WITH LOCAL CHECK OPTION;
-- fixture_teardown:
DROP TABLE IF EXISTS t_cv_flashback_source CASCADE;
DROP TABLE IF EXISTS t_view_source CASCADE;
