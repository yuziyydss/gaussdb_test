...
-- case_id: manifest_alter_resource_pool_ordinary_64fbc2614e12
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"options": "alter_resource_pool_options_memory_limit_min"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_resource_pool_fact_privilege"], "key": "resource_pool_admin"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_upgrade"], "key": "upgrade_in_progress"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_multitenant"], "key": "multitenant"}, {"allowed_values": ["complex_jobs_only"], "fact_refs": ["alter_resource_pool_fact_complex_jobs"], "key": "io_control_scope"}, {"allowed_values": ["High,Medium"], "fact_refs": ["alter_resource_pool_fact_timeshare"], "key": "default_timeshare_groups_available"}]
-- fixture_setup:
CREATE RESOURCE POOL b9_pool;
-- test_sql:
ALTER RESOURCE POOL b9_pool WITH (MEMORY_LIMIT = '1KB');
-- fixture_teardown:
DROP RESOURCE POOL IF EXISTS b9_pool;

-- case_id: manifest_alter_resource_pool_ordinary_bcf8c4676d9c
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"options": "alter_resource_pool_options_memory_limit_mb"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_resource_pool_fact_privilege"], "key": "resource_pool_admin"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_upgrade"], "key": "upgrade_in_progress"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_multitenant"], "key": "multitenant"}, {"allowed_values": ["complex_jobs_only"], "fact_refs": ["alter_resource_pool_fact_complex_jobs"], "key": "io_control_scope"}, {"allowed_values": ["High,Medium"], "fact_refs": ["alter_resource_pool_fact_timeshare"], "key": "default_timeshare_groups_available"}]
-- fixture_setup:
CREATE RESOURCE POOL b9_pool;
-- test_sql:
ALTER RESOURCE POOL b9_pool WITH (MEMORY_LIMIT = '1MB');
-- fixture_teardown:
DROP RESOURCE POOL IF EXISTS b9_pool;

-- case_id: manifest_alter_resource_pool_ordinary_287b9a68fdf9
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"options": "alter_resource_pool_options_memory_limit_max"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_resource_pool_fact_privilege"], "key": "resource_pool_admin"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_upgrade"], "key": "upgrade_in_progress"}, {"allowed_values": ["false"], "fact_refs": ["alter_resource_pool_fact_no_multitenant"], "key": "multitenant"}, {"allowed_values": ["complex_jobs_only"], "fact_refs": ["alter_resource_pool_fact_complex_jobs"], "key": "io_control_scope"}, {"allowed_values": ["High,Medium"], "fact_refs": ["alter_resource_pool_fact_timeshare"], "key": "default_timeshare_groups_available"}]
-- fixture_setup:
CREATE RESOURCE POOL b9_pool;
-- test_sql:
ALTER RESOURCE POOL b9_pool WITH (MEMORY_LIMIT = '2047GB');
-- fixture_teardown:
DROP RESOURCE POOL IF EXISTS b9_pool;
