-- generated_from: manifest_create_model_fresh_logistic
-- static_only: true
-- case_count: 1

-- case_id: manifest_create_model_fresh_logistic_c093b2da8ef3
-- expected: success
...
-- params: {"architecture": "create_model_architecture_logistic", "features": "create_model_features_size_lot", "hyperparameters": "create_model_hyperparameters_example", "model_name": "create_model_model_name_fresh", "target": "create_model_target_mark", "training_source": "create_model_training_source_fixture"}
...
-- test_sql:
CREATE MODEL g_create_model_price USING logistic_regression FEATURES size, lot TARGET mark FROM fp_model_houses_input WITH learning_rate=0.88, max_iterations=default;
-- fixture_teardown:
ROLLBACK;
