-- generated_from: manifest_alter_foreign_table_log_implicit
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_foreign_table_log_implicit_be7a2c32cc0d
-- expected: success
...
-- params: {"operation": "aft_log_implicit", "option_value": "aft_log_two", "table_name": "aft_log_table"}
...
-- test_sql:
ALTER FOREIGN TABLE g_a3_aft_ns.foreign_table OPTIONS ( latest_files '2');
-- fixture_teardown:
