-- generated_from: manifest_alter_user_lock
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_user_lock_69254ffb74e2
-- expected: success
...
-- params: {"assignment": "alter_user_assignment_to", "form": "alter_user_form_lock", "options": "alter_user_options_nologin", "reset_target": "alter_user_reset_target_one", "value": "alter_user_value_on", "with_keyword": "alter_user_with_keyword_none"}
