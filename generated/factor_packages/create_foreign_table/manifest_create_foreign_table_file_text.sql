-- generated_from: manifest_create_foreign_table_file_text
-- static_only: true
-- case_count: 1

-- case_id: manifest_create_foreign_table_file_text_d7a2b47c1fcf
-- expected: success
...
-- params: {"column_definitions": "create_foreign_table_file_columns", "format": "create_foreign_table_format_text_file_fresh", "if_not_exists": "create_foreign_table_if_not_exists_file_fresh", "server_name": "create_foreign_table_file_server", "table_name": "create_foreign_table_file_target", "table_options": "create_foreign_table_file_options_text"}
...
-- test_sql:
CREATE FOREIGN TABLE g_cft_file_ns.rows (id INTEGER, qty INTEGER) SERVER g_cft_file_server OPTIONS (format 'text', filename '/tmp/factor_assets/general/create_foreign_table/rows.tsv', encoding 'UTF8');
-- fixture_teardown:
