-- generated_from: manifest_alter_role_from_current
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_role_from_current_b122c9e54034
-- expected: success
...
-- params: {"assignment": "alter_role_assignment_to", "form": "alter_role_form_from_current", "options": "alter_role_options_nologin", "reset_target": "alter_role_reset_target_one", "value": "alter_role_value_postgres", "with_keyword": "alter_role_with_keyword_none"}
...
-- test_sql:
ALTER ROLE b9_role_a SET DATESTYLE FROM CURRENT;
-- fixture_teardown:
