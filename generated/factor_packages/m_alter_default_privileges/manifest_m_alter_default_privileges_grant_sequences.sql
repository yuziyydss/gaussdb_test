-- generated_from: manifest_m_alter_default_privileges_grant_sequences
-- static_only: true
-- case_count: 4
...
-- case_id: manifest_m_alter_default_privileges_grant_sequences_036f1d2915f2
-- expected: success
...
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace GRANT SELECT ON SEQUENCES TO m_b04_role_existing;
-- fixture_teardown:
...
-- case_id: manifest_m_alter_default_privileges_grant_sequences_fe71af8c6b19
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"action": "m_alter_default_privileges_action_grant", "behavior": "m_alter_default_privileges_behavior_default", "grant_option": "m_alter_default_privileges_grant_option_yes", "object": "m_alter_default_privileges_object_sequences", "privilege": "m_alter_default_privileges_privilege_usage", "revoke_option": "m_alter_default_privileges_revoke_option_none"}
-- environment_requirements: [{"allowed_values": ["M"], "fact_refs": ["m_alter_default_privileges_fact_mode"], "key": "compatibility_mode"}, {"allowed_values": ["sysadmin"], "fact_refs": ["m_create_role::m_create_role_fact_disable_authority"], "key": "actor_authority"}, {"allowed_values": ["off"], "fact_refs": ["m_create_role::m_create_role_fact_creation_authority"], "key": "separation_of_duties"}, {"allowed_values": ["same_schema_creating_session"], "fact_refs": ["m_alter_default_privileges_fact_owner", "m_alter_default_privileges_fact_schema"], "key": "default_acl_creator"}]
-- fixture_setup:
CREATE ROLE m_b04_role_existing NOLOGIN NOSYSADMIN PASSWORD DISABLE;
CREATE ROLE m_b04_role_second NOLOGIN NOSYSADMIN PASSWORD DISABLE;
...
GRANT USAGE ON SCHEMA m_default_privilege_namespace TO m_b04_role_existing;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace GRANT USAGE ON SEQUENCES TO m_b04_role_existing WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON TABLES FROM m_b04_role_existing RESTRICT;
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON SEQUENCES FROM m_b04_role_existing RESTRICT;
DROP SCHEMA m_default_privilege_namespace;
...
-- case_id: manifest_m_alter_default_privileges_grant_sequences_7e62f9107833
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA m_default_privilege_namespace TO m_b04_role_existing;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace GRANT SELECT ON SEQUENCES TO m_b04_role_existing WITH GRANT OPTION;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON TABLES FROM m_b04_role_existing RESTRICT;
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON SEQUENCES FROM m_b04_role_existing RESTRICT;
DROP SCHEMA m_default_privilege_namespace;
...
-- case_id: manifest_m_alter_default_privileges_grant_sequences_7e541a4c3fbc
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
GRANT USAGE ON SCHEMA m_default_privilege_namespace TO m_b04_role_existing;
-- test_sql:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace GRANT USAGE ON SEQUENCES TO m_b04_role_existing;
-- fixture_teardown:
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON TABLES FROM m_b04_role_existing RESTRICT;
ALTER DEFAULT PRIVILEGES IN SCHEMA m_default_privilege_namespace REVOKE ALL PRIVILEGES ON SEQUENCES FROM m_b04_role_existing RESTRICT;
DROP SCHEMA m_default_privilege_namespace;
