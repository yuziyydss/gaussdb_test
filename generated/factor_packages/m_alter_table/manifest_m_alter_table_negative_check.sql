-- generated_from: manifest_m_alter_table_negative_check
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_alter_table_negative_check_653b7262105c
-- expected: error
-- expected_error_category: existing_rows_satisfy_check
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"column": "m_alter_table_column_none", "constraint_action": "m_alter_table_constraint_action_bad_check", "default_action": "m_alter_table_default_action_set", "equals": "m_alter_table_equals_none", "form": "m_alter_table_form_constraint", "if_exists": "m_alter_table_if_exists_none", "position": "m_alter_table_position_none", "rename_keyword": "m_alter_table_rename_keyword_none", "storage_action": "m_alter_table_storage_action_low"}
...
-- test_sql:
ALTER TABLE m_alter_table_namespace.source ADD CONSTRAINT m_at_negative CHECK (qty < 0);
-- fixture_teardown:
