-- generated_from: manifest_m_select_min_float
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_select_min_float_d3b56b4c80be
-- expected: success
...
-- test_sql:
SELECT MIN(qty) AS result FROM m_select_approximate_ns.float_source;
-- fixture_teardown:
