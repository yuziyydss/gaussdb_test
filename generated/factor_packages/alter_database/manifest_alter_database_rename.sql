-- generated_from: manifest_alter_database_rename
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_database_rename_ead1f8d32273
-- expected: success
...
-- params: {"assignment": "alter_database_assignment_to", "form": "alter_database_form_rename", "limit": "alter_database_limit_nminus1", "reset_target": "alter_database_reset_target_one", "value": "alter_database_value_postgres", "with_keyword": "alter_database_with_keyword_none"}
...
SELECT 1 / (1 - COUNT(*)) AS assert_rename_target_absent FROM pg_database WHERE datname = 'b8_database_renamed';
-- test_sql:
ALTER DATABASE b8_database RENAME TO b8_database_renamed;
-- fixture_teardown:
DROP DATABASE IF EXISTS b8_database_renamed PURGE;
