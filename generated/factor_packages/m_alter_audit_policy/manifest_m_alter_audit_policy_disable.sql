-- generated_from: manifest_m_alter_audit_policy_disable
-- static_only: true
-- case_count: 2
...
-- case_id: manifest_m_alter_audit_policy_disable_b53f7da99d02
-- expected: success
...
-- params: {"change": "m_alter_audit_policy_change_disable", "if_exists": "m_alter_audit_policy_if_exists_none"}
...
CREATE AUDIT POLICY m_alter_audit_policy_existing PRIVILEGES CREATE ON LABEL (m_b05_audit_label) FILTER ON IP('127.0.0.1') ENABLE;
-- test_sql:
ALTER AUDIT POLICY m_alter_audit_policy_existing DISABLE;
-- fixture_teardown:
...
-- case_id: manifest_m_alter_audit_policy_disable_3032ebf8cdc0
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"change": "m_alter_audit_policy_change_disable", "if_exists": "m_alter_audit_policy_if_exists_yes"}
-- environment_requirements: [{"allowed_values": ["M"], "fact_refs": ["m_alter_audit_policy_fact_mode"], "key": "compatibility_mode"}, {"allowed_values": ["sysadmin"], "fact_refs": ["m_alter_audit_policy_fact_authority"], "key": "actor_authority"}, {"allowed_values": ["on"], "fact_refs": ["m_alter_audit_policy_fact_security_on"], "key": "enable_security_policy"}]
-- fixture_setup:
CREATE SCHEMA m_label_namespace;
CREATE TABLE m_label_namespace.source (id INTEGER, qty INTEGER);
...
CREATE AUDIT POLICY m_alter_audit_policy_existing PRIVILEGES CREATE ON LABEL (m_b05_audit_label) FILTER ON IP('127.0.0.1') ENABLE;
-- test_sql:
ALTER AUDIT POLICY IF EXISTS m_alter_audit_policy_existing DISABLE;
-- fixture_teardown:
DROP AUDIT POLICY IF EXISTS m_alter_audit_policy_existing;
DROP RESOURCE LABEL IF EXISTS m_b05_audit_label;
DROP VIEW m_label_namespace.source_view;
