-- generated_from: manifest_alter_event_preserve
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_preserve_7d590d434bee
-- expected: success
...
-- params: {"operation": "alter_event_operation_preserve"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing ON COMPLETION PRESERVE;
-- fixture_teardown:
