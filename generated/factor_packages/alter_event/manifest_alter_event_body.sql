-- generated_from: manifest_alter_event_body
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_body_982aba37f6be
-- expected: success
...
-- params: {"operation": "alter_event_operation_body"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing DO INSERT INTO fp_cs_one.b10_event_source VALUES (3,4);
-- fixture_teardown:
