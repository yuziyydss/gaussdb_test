-- generated_from: manifest_alter_event_slave
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_slave_71f954e3b57b
-- expected: success
...
-- params: {"operation": "alter_event_operation_slave"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing DISABLE ON SLAVE;
-- fixture_teardown:
