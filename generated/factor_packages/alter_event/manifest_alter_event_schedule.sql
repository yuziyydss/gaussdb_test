-- generated_from: manifest_alter_event_schedule
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_schedule_c74306d135f1
-- expected: success
...
-- params: {"operation": "alter_event_operation_schedule"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing ON SCHEDULE EVERY 2 DAY;
-- fixture_teardown:
