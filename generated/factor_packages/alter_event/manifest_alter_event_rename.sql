-- generated_from: manifest_alter_event_rename
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_rename_fe6e3e1aba87
-- expected: success
...
-- params: {"operation": "alter_event_operation_rename"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing RENAME TO fp_cs_one.b10_event_renamed;
-- fixture_teardown:
DROP EVENT IF EXISTS fp_cs_one.b10_event_renamed;
