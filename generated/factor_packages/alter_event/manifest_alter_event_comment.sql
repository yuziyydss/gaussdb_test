-- generated_from: manifest_alter_event_comment
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_event_comment_76b1e4b50ac5
-- expected: success
...
-- params: {"operation": "alter_event_operation_comment"}
...
-- test_sql:
ALTER EVENT fp_cs_one.b10_event_existing COMMENT 'b10 changed event';
-- fixture_teardown:
