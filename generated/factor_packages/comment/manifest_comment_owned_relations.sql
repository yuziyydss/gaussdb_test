...
-- case_id: manifest_comment_owned_relations_a59e98b7c5b3
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"target": "comment_target_view_column_2_fresh", "text": "comment_text_plain"}
-- environment_requirements: [{"allowed_values": ["fixture_object_owner"], "fact_refs": ["comment_fact_authority"], "key": "comment_authority"}, {"allowed_values": ["fixture_table_owner_with_create_index_authority"], "fact_refs": ["create_index::ci_fact_permissions"], "key": "index_create_authority"}, {"allowed_values": ["create_any_table_in_owned_user_schema"], "fact_refs": ["create_view::cv_fact_create_any_table_permission"], "key": "view_create_authority"}]
-- fixture_setup:
CREATE TABLE g_comment_rel_base (col_1 INTEGER, col_2 INTEGER) WITH (storage_type=astore);
INSERT INTO g_comment_rel_base VALUES (1,2),(3,4);
...
CREATE VIEW g_comment_rel_view AS SELECT col_1,col_2 FROM g_comment_rel_base;
-- test_sql:
COMMENT ON COLUMN g_comment_rel_view.col_2 IS 'factor note';
-- fixture_teardown:
DROP VIEW g_comment_rel_view;
DROP INDEX g_comment_rel_idx;
DROP TABLE g_comment_rel_base;

-- case_id: manifest_comment_owned_relations_2572e45194f6
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"target": "comment_target_view_column_2_fresh", "text": "comment_text_unicode"}
-- environment_requirements: [{"allowed_values": ["fixture_object_owner"], "fact_refs": ["comment_fact_authority"], "key": "comment_authority"}, {"allowed_values": ["fixture_table_owner_with_create_index_authority"], "fact_refs": ["create_index::ci_fact_permissions"], "key": "index_create_authority"}, {"allowed_values": ["create_any_table_in_owned_user_schema"], "fact_refs": ["create_view::cv_fact_create_any_table_permission"], "key": "view_create_authority"}]
-- fixture_setup:
CREATE TABLE g_comment_rel_base (col_1 INTEGER, col_2 INTEGER) WITH (storage_type=astore);
INSERT INTO g_comment_rel_base VALUES (1,2),(3,4);
...
CREATE VIEW g_comment_rel_view AS SELECT col_1,col_2 FROM g_comment_rel_base;
-- test_sql:
COMMENT ON COLUMN g_comment_rel_view.col_2 IS '测试注释';
-- fixture_teardown:
DROP VIEW g_comment_rel_view;
DROP INDEX g_comment_rel_idx;
DROP TABLE g_comment_rel_base;

-- case_id: manifest_comment_owned_relations_87c5230b5e2d
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"target": "comment_target_view_column_2_fresh", "text": "comment_text_quote"}
-- environment_requirements: [{"allowed_values": ["fixture_object_owner"], "fact_refs": ["comment_fact_authority"], "key": "comment_authority"}, {"allowed_values": ["fixture_table_owner_with_create_index_authority"], "fact_refs": ["create_index::ci_fact_permissions"], "key": "index_create_authority"}, {"allowed_values": ["create_any_table_in_owned_user_schema"], "fact_refs": ["create_view::cv_fact_create_any_table_permission"], "key": "view_create_authority"}]
-- fixture_setup:
CREATE TABLE g_comment_rel_base (col_1 INTEGER, col_2 INTEGER) WITH (storage_type=astore);
INSERT INTO g_comment_rel_base VALUES (1,2),(3,4);
...
CREATE VIEW g_comment_rel_view AS SELECT col_1,col_2 FROM g_comment_rel_base;
-- test_sql:
COMMENT ON COLUMN g_comment_rel_view.col_2 IS 'owner''s note';
-- fixture_teardown:
DROP VIEW g_comment_rel_view;
DROP INDEX g_comment_rel_idx;
DROP TABLE g_comment_rel_base;

-- case_id: manifest_comment_owned_relations_43ebec894162
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"target": "comment_target_view_column_2_fresh", "text": "comment_text_null"}
-- environment_requirements: [{"allowed_values": ["fixture_object_owner"], "fact_refs": ["comment_fact_authority"], "key": "comment_authority"}, {"allowed_values": ["fixture_table_owner_with_create_index_authority"], "fact_refs": ["create_index::ci_fact_permissions"], "key": "index_create_authority"}, {"allowed_values": ["create_any_table_in_owned_user_schema"], "fact_refs": ["create_view::cv_fact_create_any_table_permission"], "key": "view_create_authority"}]
-- fixture_setup:
CREATE TABLE g_comment_rel_base (col_1 INTEGER, col_2 INTEGER) WITH (storage_type=astore);
INSERT INTO g_comment_rel_base VALUES (1,2),(3,4);
...
CREATE VIEW g_comment_rel_view AS SELECT col_1,col_2 FROM g_comment_rel_base;
-- test_sql:
COMMENT ON COLUMN g_comment_rel_view.col_2 IS NULL;
-- fixture_teardown:
DROP VIEW g_comment_rel_view;
DROP INDEX g_comment_rel_idx;
DROP TABLE g_comment_rel_base;
