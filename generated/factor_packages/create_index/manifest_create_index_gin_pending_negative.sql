-- generated_from: manifest_create_index_gin_pending_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_create_index_gin_pending_negative_6903b6648069
-- expected: error
-- expected_error_category: gin_pending_list_limit_out_of_range
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"comment_clause": "ci_comment_none", "concurrently": "ci_concurrently_none", "if_not_exists": "ci_if_not_exists_none", "ilm_clause": "ci_ilm_none", "include_profile": "ci_include_none", "index_name_presence": "ci_index_name_present", "key_profile": "ci_key_gin_array", "method": "ci_method_gin", "predicate_clause": "ci_predicate_none", "scope_clause": "ci_scope_none", "statement_form": "ci_statement_regular", "storage_profile": "ci_gin_pending_63", "table_profile": "ci_table_gin_storage", "tablespace_clause": "ci_tablespace_none", "unique_modifier": "ci_unique_none", "visibility_clause": "ci_visibility_none"}
...
-- test_sql:
CREATE INDEX idx_ci_gin_pending_negative_6903b664 ON g_ci_gin_storage USING gin (info) WITH (gin_pending_list_limit = 63);
-- fixture_teardown:
