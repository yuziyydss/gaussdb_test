-- generated_from: manifest_update_generated_storage_default
-- static_only: true
-- case_count: 1

-- case_id: manifest_update_generated_storage_default_c927d5a76379
-- expected: success
...
INSERT INTO g_generated_implicit_dst (id, qty) VALUES (2, 9), (3, 8);
-- test_sql:
UPDATE g_generated_implicit_dst SET total = DEFAULT WHERE id = 2;
-- fixture_teardown:
