...
-- case_id: manifest_alter_table_default_negative_40ed0d26108f
-- expected: error
-- expected_error_category: unsupported_nextval_default
-- expected_sqlstates: 0A000,42P01
-- expected_error_regex: (?i)(nextval|default|sequence|support)
-- params: {"action_profile": "at_action_add_nextval", "column_keyword": "at_column_keyword", "ddl_mode": "at_mode_default", "if_exists": "at_if_exists_none", "rename_operator": "at_rename_to", "statement_form": "at_statement_action", "table_profile": "at_table_regular", "target_form": "at_target_plain"}
-- fixture_setup:
