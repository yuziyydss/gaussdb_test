...
-- case_id: manifest_alter_table_online_positive_0af9a890117b
-- expected: success
...
-- case_id: manifest_alter_table_online_positive_11abfae4dc93
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE WITH (parallel_threads = 4) IF EXISTS t_at_regular ALTER COLUMN required_later SET NOT NULL;
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_d6b543ced3c4
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_38e004811d31
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_9a80fcf4f515
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_a1f855af65bb
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE WITH (max_catchup_times = 10) IF EXISTS t_at_regular ALTER COLUMN note TYPE VARCHAR(96);
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_9dc01e174468
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE t_at_regular ALTER COLUMN required_later SET NOT NULL;
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_af0cfdc5aa37
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_04a55c2754c0
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE IF EXISTS t_at_regular ADD CONSTRAINT pk_at_id PRIMARY KEY (id);
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_036ce6d76220
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_272a30406b01
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE WITH (parallel_threads = 4) t_at_regular ALTER COLUMN note TYPE VARCHAR(96);
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_5ef97b89fb97
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_f6fbfab24be0
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE WITH (max_catchup_times = 10) t_at_regular ALTER COLUMN required_later SET NOT NULL;
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
...
-- case_id: manifest_alter_table_online_positive_987c5b91bc9f
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
-- case_id: manifest_alter_table_online_positive_d83a8381d548
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
...
INSERT INTO t_at_regular (id, code, note, amount, required_later, identity_text) VALUES (1, 'A001', 'alpha', 10, 100, 'text_1'), (2, 'A002', 'beta', 20, 200, 'text_2');
-- test_sql:
ALTER TABLE ONLINE WITH (max_catchup_times = 10) t_at_regular ADD CONSTRAINT pk_at_id PRIMARY KEY (id);
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
