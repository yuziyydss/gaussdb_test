-- generated_from: manifest_alter_table_identity_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_table_identity_negative_3bc3eb3f673e
-- expected: error
-- expected_error_category: invalid_identity_type
-- expected_sqlstates: 42804,0A000
-- expected_error_regex: (?i)(identity|type|numeric|integer)
-- params: {"action_profile": "at_action_identity_varchar", "column_keyword": "at_column_keyword", "ddl_mode": "at_mode_default", "if_exists": "at_if_exists_none", "rename_operator": "at_rename_to", "statement_form": "at_statement_action", "table_profile": "at_table_regular", "target_form": "at_target_plain"}
-- fixture_setup:
...
-- test_sql:
ALTER TABLE t_at_regular ALTER COLUMN note ADD GENERATED ALWAYS AS IDENTITY;
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
