-- generated_from: manifest_alter_table_storage_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_table_storage_negative_9ca0c53fe4ea
-- expected: error
-- expected_error_category: immutable_storage_parameter
-- expected_sqlstates: 0A000,22023
-- expected_error_regex: (?i)(orientation|support|parameter)
-- params: {"action_profile": "at_action_set_orientation", "column_keyword": "at_column_keyword", "ddl_mode": "at_mode_default", "if_exists": "at_if_exists_none", "rename_operator": "at_rename_to", "statement_form": "at_statement_action", "table_profile": "at_table_regular", "target_form": "at_target_plain"}
-- fixture_setup:
...
-- test_sql:
ALTER TABLE t_at_regular SET (orientation = column);
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
