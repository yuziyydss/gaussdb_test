-- generated_from: manifest_m_alter_extension_internal_drop
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_alter_extension_internal_drop_f47227f952aa
-- expected: success
...
-- params: {"action": "m_alter_extension_action_drop"}
...
-- test_sql:
ALTER EXTENSION security_plugin DROP TABLE m_extension_namespace.member_table;
-- fixture_teardown:
