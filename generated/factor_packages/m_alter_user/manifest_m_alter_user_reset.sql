-- generated_from: manifest_m_alter_user_reset
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_alter_user_reset_242b61525ded
-- expected: success
...
-- params: {"form": "m_alter_user_form_reset", "option": "m_alter_user_option_no_login", "parameter_change": "m_alter_user_parameter_change_default", "with_keyword": "m_alter_user_with_keyword_none"}
...
-- test_sql:
ALTER USER m_b04_user_existing RESET ALL;
-- fixture_teardown:
