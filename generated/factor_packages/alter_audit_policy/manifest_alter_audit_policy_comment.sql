-- generated_from: manifest_alter_audit_policy_comment
-- static_only: true
-- case_count: 2

-- case_id: manifest_alter_audit_policy_comment_2a1478cdd087
-- expected: success
...
-- params: {"if_exists": "alter_audit_policy_if_exists_none", "operation": "alter_audit_policy_operation_comment"}
...
-- test_sql:
ALTER AUDIT POLICY b10_audit_existing COMMENTS 'b10 audit policy';
-- fixture_teardown:
...
-- case_id: manifest_alter_audit_policy_comment_d585da5d703b
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"if_exists": "alter_audit_policy_if_exists_yes", "operation": "alter_audit_policy_operation_comment"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_audit_policy_fact_privilege"], "key": "security_policy_admin"}, {"allowed_values": ["on"], "fact_refs": ["alter_audit_policy_fact_switch"], "key": "enable_security_policy"}]
-- fixture_setup:
CREATE SCHEMA fp_cs_one;
CREATE SCHEMA fp_cs_two;
...
CREATE AUDIT POLICY b10_audit_existing PRIVILEGES CREATE DISABLE;
-- test_sql:
ALTER AUDIT POLICY IF EXISTS b10_audit_existing COMMENTS 'b10 audit policy';
-- fixture_teardown:
DROP AUDIT POLICY IF EXISTS b10_audit_existing;
DROP RESOURCE LABEL IF EXISTS b9_rl_b;
DROP RESOURCE LABEL IF EXISTS b9_rl_a;
