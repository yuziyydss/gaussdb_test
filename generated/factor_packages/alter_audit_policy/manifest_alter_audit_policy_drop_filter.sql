-- generated_from: manifest_alter_audit_policy_drop_filter
-- static_only: true
-- case_count: 2

-- case_id: manifest_alter_audit_policy_drop_filter_40fb4492625e
-- expected: success
...
-- params: {"if_exists": "alter_audit_policy_if_exists_none", "operation": "alter_audit_policy_operation_drop_filter"}
...
CREATE AUDIT POLICY b10_audit_existing PRIVILEGES CREATE FILTER ON IP('127.0.0.1') DISABLE;
-- test_sql:
ALTER AUDIT POLICY b10_audit_existing DROP FILTER;
-- fixture_teardown:
...
-- case_id: manifest_alter_audit_policy_drop_filter_487d325e2dec
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"if_exists": "alter_audit_policy_if_exists_yes", "operation": "alter_audit_policy_operation_drop_filter"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_audit_policy_fact_privilege"], "key": "security_policy_admin"}, {"allowed_values": ["on"], "fact_refs": ["alter_audit_policy_fact_switch"], "key": "enable_security_policy"}]
-- fixture_setup:
CREATE SCHEMA fp_cs_one;
CREATE SCHEMA fp_cs_two;
...
CREATE AUDIT POLICY b10_audit_existing PRIVILEGES CREATE FILTER ON IP('127.0.0.1') DISABLE;
-- test_sql:
ALTER AUDIT POLICY IF EXISTS b10_audit_existing DROP FILTER;
-- fixture_teardown:
DROP AUDIT POLICY IF EXISTS b10_audit_existing;
DROP RESOURCE LABEL IF EXISTS b9_rl_b;
DROP RESOURCE LABEL IF EXISTS b9_rl_a;
