-- generated_from: manifest_alter_audit_policy_remove
-- static_only: true
-- case_count: 2

-- case_id: manifest_alter_audit_policy_remove_3c593716be81
-- expected: success
...
-- params: {"if_exists": "alter_audit_policy_if_exists_none", "operation": "alter_audit_policy_operation_remove"}
...
-- test_sql:
ALTER AUDIT POLICY b10_audit_existing REMOVE PRIVILEGES (DROP);
-- fixture_teardown:
...
-- case_id: manifest_alter_audit_policy_remove_00873706bfb6
-- expected: success
-- expected_error_category: -
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: confirmed
-- expected_scope: syntax_only
-- params: {"if_exists": "alter_audit_policy_if_exists_yes", "operation": "alter_audit_policy_operation_remove"}
-- environment_requirements: [{"allowed_values": ["true"], "fact_refs": ["alter_audit_policy_fact_privilege"], "key": "security_policy_admin"}, {"allowed_values": ["on"], "fact_refs": ["alter_audit_policy_fact_switch"], "key": "enable_security_policy"}]
-- fixture_setup:
CREATE SCHEMA fp_cs_one;
CREATE SCHEMA fp_cs_two;
...
ALTER AUDIT POLICY b10_audit_existing ADD PRIVILEGES (DROP);
-- test_sql:
ALTER AUDIT POLICY IF EXISTS b10_audit_existing REMOVE PRIVILEGES (DROP);
-- fixture_teardown:
DROP AUDIT POLICY IF EXISTS b10_audit_existing;
DROP AUDIT POLICY IF EXISTS b10_audit_existing;
DROP RESOURCE LABEL IF EXISTS b9_rl_b;
