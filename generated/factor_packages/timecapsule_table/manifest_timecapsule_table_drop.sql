-- generated_from: manifest_timecapsule_table_drop
-- static_only: true
-- case_count: 1

-- case_id: manifest_timecapsule_table_drop_bc8293f05128
-- expected: success
...
-- params: {"restore": "timecapsule_table_restore_drop"}
...
-- test_sql:
TIMECAPSULE TABLE fp_cs_one.b11_flash_source TO BEFORE DROP;
-- fixture_teardown:
