-- generated_from: manifest_timecapsule_table_truncate
-- static_only: true
-- case_count: 1

-- case_id: manifest_timecapsule_table_truncate_7e25e047f50d
-- expected: success
...
-- params: {"restore": "timecapsule_table_restore_truncate"}
...
TRUNCATE TABLE fp_cs_one.b11_flash_source;
-- test_sql:
TIMECAPSULE TABLE fp_cs_one.b11_flash_source TO BEFORE TRUNCATE;
-- fixture_teardown:
