"""Two source-conflict packages close static coverage without behavior claims."""
...
FACTORS=['m_copy','m_create_audit_policy']
EXPECTED_FACTS={
 'm_copy':['m_copy_fact_null_conflict'],
 'm_create_audit_policy':['m_create_audit_policy_fact_multi_ambiguity','m_create_audit_policy_fact_wording'],
}


class StaticCoverageClosureIVTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
