...
class PreparedNegativeIntegrationTests(unittest.TestCase):
    ...
    def test_auditor_keeps_extended_set_domain_gap_without_wrong_fact_consumers(self):
        ...
        self.assertEqual(len(matrix.documented_features), 2)
        ...
        self.assertEqual(matrix.documented_features[1].id, 'm_set_feature_user_variable_extended_domain')
        self.assertEqual(matrix.documented_features[1].status, 'needs_profile')
