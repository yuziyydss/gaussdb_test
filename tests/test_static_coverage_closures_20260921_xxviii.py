"""Two-phase, reset, snapshot, and load data static closures."""
...
PACKAGES = {
    ...
    "reset": (
        [
            "reset_fact_parameter_domain",
            "reset_fact_alter_session_gap",
        ],
        6,
    ),
    "snapshot": (
        [
            "snapshot_fact_version_graph",
            "snapshot_fact_comment_bracket",
        ],
        4,
    ),
    "load_data": (
        [
            "load_data_fact_runtime_contract",
            "load_data_fact_set_bracket",
        ],
        2,
    ),
}
...
class StaticCoverageClosureXXXVTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
