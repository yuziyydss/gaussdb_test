"""Weak dictionary, function, resource pool, and role static closures."""
...
PACKAGES = {
    "create_weak_password_dictionary": (
        [
            "create_weak_password_dictionary_fact_dictionary_restore",
            "create_weak_password_dictionary_fact_tuple_ambiguity",
        ],
        2,
    ),
    "drop_function": (
        [
            "drop_function_fact_temporary_lifecycle",
            "drop_function_fact_dependencies",
        ],
        11,
    ),
    "drop_resource_pool": (
        [
            "drop_resource_pool_fact_bound_role_profile",
            "drop_resource_pool_fact_missing_profile",
        ],
        2,
    ),
    "drop_role": (
        [
            "drop_role_fact_ownership_dependencies",
            "drop_role_fact_missing_profile",
        ],
        4,
    ),
}
...
class StaticCoverageClosureXXXIITests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
