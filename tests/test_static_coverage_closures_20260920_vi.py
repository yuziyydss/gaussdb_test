...
FACTORS=['checkpoint','m_show']
EXPECTED_FACTS={
 'checkpoint':['checkpoint_fact_interval_profile'],
 'm_show':['m_show_fact_metadata_gap'],
}


class StaticCoverageClosureVITests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
