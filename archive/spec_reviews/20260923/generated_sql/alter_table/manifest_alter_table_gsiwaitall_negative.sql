-- generated_from: manifest_alter_table_gsiwaitall_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_table_gsiwaitall_negative_005bc3da1a73
-- expected: error
-- expected_error_category: unsupported_gsiwaitall
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"action_profile": "at_action_gsiwaitall", "add_column_items": "at_add_columns_two", "column_keyword": "at_column_keyword", "ddl_mode": "at_mode_default", "if_exists": "at_if_exists_none", "modify_column_items": "at_modify_columns_two", "rename_operator": "at_rename_to", "statement_form": "at_statement_gsiwaitall", "table_profile": "at_table_regular", "target_form": "at_target_plain"}
-- fixture_setup:
...
-- test_sql:
ALTER TABLE t_at_regular GSIWAITALL;
-- fixture_teardown:
DROP TABLE IF EXISTS at_target_schema.t_at_regular CASCADE;
DROP TABLE IF EXISTS t_at_renamed CASCADE;
DROP TABLE IF EXISTS t_at_regular CASCADE;
