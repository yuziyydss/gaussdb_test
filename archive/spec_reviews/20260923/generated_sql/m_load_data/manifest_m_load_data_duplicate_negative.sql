-- generated_from: manifest_m_load_data_duplicate_negative
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_load_data_duplicate_negative_00503add1b37
-- expected: error
-- expected_error_category: collision_error
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"assignment": "m_load_data_assignment_none", "column_list": "m_load_data_column_list_default", "conflict_mode": "m_load_data_conflict_mode_none", "fields": "m_load_data_fields_default", "skip": "m_load_data_skip_none", "table": "m_load_data_table_conflict"}
...
-- test_sql:
LOAD DATA INFILE '/tmp/m_factor_assets/load_data/two_int.tsv' INTO TABLE m_load_data_conflict LINES TERMINATED BY '
';
-- fixture_teardown:
