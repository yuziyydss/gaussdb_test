-- generated_from: manifest_m_create_user_connection_below
-- static_only: true
-- case_count: 1
...
-- case_id: manifest_m_create_user_connection_below_2b4c18c7223f
-- expected: error
...
-- params: {"connection_limit": "m_create_user_connection_limit_below", "inherit": "m_create_user_inherit_yes", "password_keyword": "m_create_user_password_keyword_password", "with_keyword": "m_create_user_with_keyword_none"}
...
-- test_sql:
CREATE USER m_create_user_new NOLOGIN NOSYSADMIN INHERIT IN ROLE m_create_user_parent CONNECTION LIMIT -2 PASSWORD DISABLE;
-- fixture_teardown:
