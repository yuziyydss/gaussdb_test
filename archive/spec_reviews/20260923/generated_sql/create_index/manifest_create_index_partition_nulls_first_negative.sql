...
-- case_id: manifest_create_index_partition_nulls_first_negative_fd390fb15fbf
-- expected: error
...
-- test_sql:
CREATE INDEX idx_ci_pnull_bad_fd390fb1 ON t_ci_partitioned (name DESC NULLS FIRST) GLOBAL;
-- fixture_teardown:
DROP TABLE IF EXISTS t_ci_partitioned CASCADE;
