-- generated_from: manifest_alter_view_column_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_view_column_negative_80d02bf152b6
-- expected: error
-- expected_error_category: undefined_column
-- expected_sqlstates: -
-- expected_error_regex: -
-- expected_oracle_status: needs_verification
-- expected_scope: syntax_and_semantics
-- params: {"action": "alter_view_action_set_default", "column_keyword": "alter_view_column_keyword_absent", "column_name": "alter_view_column_name_missing", "expression": "alter_view_expression_integer", "if_exists": "alter_view_if_exists_absent", "new_name": "alter_view_new_name_new", "new_owner": "alter_view_new_owner_role", "new_schema": "alter_view_new_schema_schema", "options": "alter_view_options_barrier_implicit", "reset_options": "alter_view_reset_options_barrier", "view_name": "alter_view_view_name_base"}
-- fixture_setup:
...
-- test_sql:
ALTER VIEW v_av_base ALTER col_missing SET DEFAULT 100;
-- fixture_teardown:
DROP VIEW IF EXISTS v_av_new;
