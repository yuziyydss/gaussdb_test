-- generated_from: manifest_alter_sequence_large_negative
-- static_only: true
-- case_count: 1

-- case_id: manifest_alter_sequence_large_negative_6fdf8900e9ec
-- expected: error
-- expected_error_category: sequence_kind_mismatch
-- expected_sqlstates: -
...
-- test_sql:
ALTER SEQUENCE seq_as_large MAXVALUE 102;
-- fixture_teardown:
